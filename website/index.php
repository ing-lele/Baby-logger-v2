...
while($event = mysqli_fetch_assoc($results)){
	...
	if ($event['category'] == "fed"){
		...
		echo "<td class='fed'><center>". date("M d y g:i a", strtotime($event['created'])) ."</center></td>";
		...
		echo "<td class='pee'><center>". date("M d y g:i a", strtotime($event['created'])) ."</center></td>";
		...
		echo "<td><center>". date("M d y g:i a", strtotime($event['created'])) ."</center></td>";
